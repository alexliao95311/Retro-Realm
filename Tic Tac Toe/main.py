...
def main():
    ...
    pygame.display.set_caption('Tic Tac Toe - Retro Realm')
    BASICFONT = pygame.font.Font('freesansbold.ttf', BASICFONTSIZE)
    NEW_SURF, NEW_RECT = makeText('vs Computer', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 130, WINDOWHEIGHT - 60)
    NEW_SURF2, NEW_RECT2 = makeText('vs Human', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 250, WINDOWHEIGHT - 60)
    board = [BLANK] * 9
    game_over = False
    x_turn = True
    msg = "Tic Tac toe"
