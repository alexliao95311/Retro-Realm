...
pygame.display.set_caption('Chess - Retro Realm')
...
def welcome():
    ...
    textsurface = bigfont.render('Chess vs Computer', False, (255, 255, 255))
    screen.blit(textsurface, (40, 10))

    medfont = pygame.font.Font("assets/Roboto-Black.ttf", 50)
    textsurface = medfont.render(
        'Retro Realm', False, (255, 255, 255))
    screen.blit(textsurface, (260, 100))
