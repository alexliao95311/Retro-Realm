...
class MyGame(object):
    ...
    def __init__(self):
        ...
        pygame.display.set_caption('Asteroids - Retro Realm')
    ...
    def do_welcome(self):
        ...
        self.welcome_asteroids = self.big_font.render("Asteroids - Retro Realm",\
                                                True, (255, 215, 0))
        self.welcome_desc =  self.medium_font.render(\
            "Click anywhere to begin!", True, (35, 107, 142))
